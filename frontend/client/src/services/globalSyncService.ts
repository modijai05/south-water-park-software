...
class GlobalSyncService {
  ...
  private constructor() {
    // MANUAL FORCED RESET - SET EVERYTHING TO ZERO
    console.log('🚨🚨 MANUAL FORCED RESET: Setting all values to ZERO NOW');
    
    // Clear all localStorage
    localStorage.clear();
    
    // Force set all values to zero in localStorage
    localStorage.setItem('forcedReset', 'true');
    localStorage.setItem('todayEntries', '0');
    localStorage.setItem('totalEntries', '0');
    localStorage.setItem('todayPeople', '0');
    localStorage.setItem('totalPeople', '0');
    localStorage.setItem('todayAdults', '0');
    localStorage.setItem('totalAdults', '0');
    localStorage.setItem('todayKids', '0');
    localStorage.setItem('totalKids', '0');
    localStorage.setItem('today150', '0');
    localStorage.setItem('today300', '0');
    localStorage.setItem('today450', '0');
    localStorage.setItem('today600', '0');
    localStorage.setItem('today100', '0');
    localStorage.setItem('today150Adults', '0');
    localStorage.setItem('today300Adults', '0');
    localStorage.setItem('today450Adults', '0');
    localStorage.setItem('today600Adults', '0');
    localStorage.setItem('today100Adults', '0');
    localStorage.setItem('today150Kids', '0');
    localStorage.setItem('today300Kids', '0');
    localStorage.setItem('today450Kids', '0');
    localStorage.setItem('today600Kids', '0');
    localStorage.setItem('today100Kids', '0');
    localStorage.setItem('todayTotalFoodCoupons', '0');
    localStorage.setItem('todayTotalFastFoodCoupons', '0');
    localStorage.setItem('todayTotalMainFoodCoupons', '0');
    localStorage.setItem('todayFinalAmount', '0');
    localStorage.setItem('todayCashAmount', '0');
    localStorage.setItem('todayUpiAmount', '0');
    localStorage.setItem('todayAdvanceAmount', '0');
    localStorage.setItem('todayKidDiscount', '0');
    localStorage.setItem('todayAdditionalDiscount', '0');
    localStorage.setItem('todayTotalDiscount', '0');
    
    // Trigger immediate reset events
    this.triggerDailyReset();
    
    // Broadcast manual forced reset
    this.broadcastEvent('manual-forced-reset', {
      timestamp: new Date().toISOString(),
      message: 'MANUAL FORCED RESET - All values set to ZERO',
      forcedReset: true,
      setToZero: true
    });
    
    // Dispatch DOM event
    window.dispatchEvent(new CustomEvent('manual-forced-reset', {
      detail: {
        timestamp: new Date().toISOString(),
        message: 'MANUAL FORCED RESET - All values set to ZERO',
        forcedReset: true,
    ...
    console.log('🧹🧹 MANUAL FORCED RESET: All values forced to ZERO');
