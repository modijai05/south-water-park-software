...
export function AdminDashboard() {
  ...
  useEffect(() => {
    console.log('🚨🚨 BRUTE FORCE: Setting TODAY\'S values to ZERO, keeping ALL-TIME data');
    ...
    console.log('🧹🧹 BRUTE FORCE: TODAY\'S values set to ZERO, ALL-TIME data will be fetched');
    
    // CONTINUOUSLY override only TODAY'S data fetching attempts
    const interval = setInterval(() => {
      console.log('🔄 BRUTE FORCE: Re-applying TODAY\'S ZERO override');
      setStats(forcedZeroStats as unknown as Stats);
      setLoading(false);
    }, 1000); // Every 1 second
  ...
  useEffect(() => {
    ...
    const handleEmergencyReset = (data: any) => {
      if (!cancelled) {
        console.log('🚨🚨 AdminDashboard: EMERGENCY RESET triggered - COMPLETE CLEAR');
        ...
        setTimeout(() => {
          if (!cancelled) {
            console.log('🔄 AdminDashboard: Emergency refresh after complete clear');
            setLoading(false);
    ...
    const handleManualForcedReset = (data: any) => {
      if (!cancelled) {
        console.log('🚨🚨 AdminDashboard: MANUAL FORCED RESET - SETTING ALL TO ZERO');
        ...
        console.log('🧹🧹 AdminDashboard: All stats manually set to ZERO');
      }
    };
