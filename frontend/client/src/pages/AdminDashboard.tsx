...
export function AdminDashboard() {
  ...
  useEffect(() => {
    console.log('🎯 TARGETED RESET: Setting TODAY\'S data to ZERO, preserving ALL-TIME data');
    ...
    console.log('🧹🧹 TARGETED RESET: TODAY\'S data set to ZERO, ALL-TIME data preserved');
